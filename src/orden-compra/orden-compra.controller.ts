...
export class OrdenCompraController {
  ...
  async actualizarNumeroRH(
    ...
    try {
      await this.ordenCompraService.actualizarNumeroRH(+id, body.nro_rh);
      return {
        success: true,
  ...
  async migrarEstados() {
    try {
      ...
      console.error('Error al migrar estados de órdenes de compra:', error);
      throw error;
    }
  }
  ...
  async uploadFile(
    ...
    try {
      ...
      console.error('❌ Error al subir archivo para orden de compra:', error);
      throw error;
    }
  }
