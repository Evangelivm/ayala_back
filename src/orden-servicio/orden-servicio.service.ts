...
export class OrdenServicioService {
    ...
    try {
      ...
      return ordenes.map((orden) => {
        ...
        return {
          ...
          items: (orden.detalles_orden_servicio || []).map((detalle) => ({
            ...detalle,
  ...
  async getMockData(id: string): Promise<OrdenServicioData> {
    ...
    const idsCamionItems = [
      ...new Set(
        ordenServicio.detalles_orden_servicio
    ...
    return {
      ...
      formatoVersion: ordenServicio.formato_pdf_version,
    };
  }
  ...
  async remove(id: number): Promise<void> {
    try {
      ...
      console.error('Error al hacer soft delete de orden de servicio:', error);
      throw new BadRequestException(
  ...
  async restore(id: number): Promise<void> {
    try {
      ...
      console.error('Error al restaurar orden de servicio:', error);
      throw new BadRequestException(
        `Error al restaurar orden de servicio: ${error.message}`,
      );
    }
  }
