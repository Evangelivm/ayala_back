...
export const ViajesEliminacionSchema = z.object({
  ...
  id_responsable: z
    .number()
    .positive('ID de responsable debe ser positivo')
    .optional(),
  id_operador: z
    .number()
  ...
  id_controlador: z
    .number()
    .positive('ID de controlador debe ser positivo')
    .optional(),
  ...
  detalle_viajes: z
    .array(DetalleViajeSchema)
    .min(1, 'Debe incluir al menos un detalle de viaje'),
});

// Schema para actualización (todos los campos opcionales excepto ID)
export const UpdateViajesEliminacionSchema =
  ViajesEliminacionSchema.partial().extend({
...
export type UpdateViajesEliminacionDto = z.infer<
  typeof UpdateViajesEliminacionSchema
>;
export type ViajesEliminacionFilterDto = z.infer<
  typeof ViajesEliminacionFilterSchema
>;
...
export type ViajesEliminacionResponse = z.infer<
  typeof ViajesEliminacionResponseSchema
>;
