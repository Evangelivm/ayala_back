...
@Injectable()
export class GreExtendidoDetectorService {
  private readonly logger = new Logger(GreExtendidoDetectorService.name);
  ...
  async forceDetection() {
    this.logger.log('Forzando detección de registros extendidos completos...');
